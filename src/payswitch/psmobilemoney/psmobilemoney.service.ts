...
import { PAYSWITCH_MERCHANTID, PAYSWITCH_TEST_BASEURL, PAYSWTICH_PROD_BASEURL, PROCESSING_CODE_DEBIT, PROCESSING_CODE_SEND } from 'src/constants';
...
export class PsmobilemoneyService {
  ...
  public mobileMoneyPayment(
    ...
    const localTransId = GeneratorUtil.generateTransactionIdPayswitch();
