...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Find all notifications' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of notifications', isArray: true }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Find a notification by ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Notification found', type: create_notification_dto_1.CreateNotificationDto }),
    (0, common_1.Get)(':id'),
